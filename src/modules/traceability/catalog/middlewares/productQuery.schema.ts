...
/**
 * Query params de `GET /traceability/products`.
 *
...
export type ProductQuery = Infer<typeof productQuerySchema>;

export const PRODUCT_PAGE_DEFAULTS = { page: 1, limit: DEFAULT_PAGE_SIZE } as const;
